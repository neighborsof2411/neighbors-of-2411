...
|---------------|--------|
| **Total Building Size** | 298,988 SF (Option 1, the analyzed configuration); 298,918 SF (Option 2, the 36-dock configuration) — MND at 23 |
...
- Nighttime noise (dock operations, back-up alarms, and any refrigeration equipment a future tenant adds) during hours when children's sleep is essential for neurodevelopment and immune function (10 PM–7 AM)
...
"Mitigated" means the City claims the project's impacts can be reduced to "less than significant" by implementing mitigation measures. Here, the only air quality measure is Tier 4 Final construction equipment (MM AQ-1, MND at 56) — a construction-phase measure — and the MND proposes no noise mitigation at all: "No mitigation measures are required" (MND at 121). Nothing in the MND restricts truck routes, truck volumes, or operating hours.

### Can conditions be changed?

Yes. Even if the project is approved, the Planning Commission can impose **Conditions of Approval** that restrict operating hours, limit truck traffic and routing, require noise barriers or other noise controls, mandate air quality monitoring, establish community benefit agreements, and require performance bonds to ensure compliance. The stronger the conditions, the less the impact on the neighborhood.
...
In our view, Rexford's business model — leasing warehouse space to logistics and fulfillment tenants as a REIT that depends on occupancy and rental income — rewards operational intensity. The MND states the project "does not propose cold storage or the use of refrigerants" (MND at 86), but nothing in the approval would bind a future tenant to that assumption.

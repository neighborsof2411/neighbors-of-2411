...
description: "2411 Glassell: a 298,988 SF industrial building proposed to operate 24/7 just 54 feet from homes and about 1,200 feet from Fletcher Mandarin Language and GATE Academy in Orange, CA. Learn the issues, review the evidence, and prepare your public comment for the Planning Commission hearing."
---
...
| What | Impact |
|------|--------|
| **Distance to Fletcher Mandarin Language and GATE Academy (Fletcher Elementary)** | About 1,200 feet |
| **Distance to Nearest Homes** | 54 feet north of the site |
| **Daily Vehicle Trips (estimate)** | 556 net new, including about 160 truck trips; could be more depending on the tenant |
...
The City prepared an **Initial Study/Mitigated Negative Declaration (IS/MND)**, a streamlined environmental review. An MND is allowed only when mitigation reduces every impact below significance, and only when the record doesn't contain substantial evidence that the project may still have a significant effect.
...
The health risk assessment's own combined construction-and-operation result is **10.07 in a million (unmitigated)** at the most-exposed home, **over** the 10-in-a-million threshold. It reaches **9.48 (mitigated)** only by requiring cleaner construction equipment. Nothing reduces the diesel from operations. The study modeled 5 loading docks (the alternate layout has 36) and the diesel fire pump at 50 hours a year (the air district says permits allow **up to 200 hours a year**). {{< cite doc="appendix-b" label="Verify Fact" >}}
{{< /fact-compare >}}
{{< /accordion >}}
...
{{< accordion title="Traffic: \"Less than significant.\"" >}}
{{< fact-compare claim="The IS/MND concludes transportation impacts are less than significant, with no mitigation." >}}
The applicant's own traffic study rates the southern truck driveway on Glassell **LOS E/F** (severe delay) today, and finds that adding the project makes it worse: evening delay rises to 293 seconds by 2050 with the project. The consultant calls this \"unavoidable,\" and no signal or other fix is proposed. Every truck enters and exits through that one driveway. (Under state law, delay itself isn't a CEQA impact; this is a **safety and General Plan** issue, and a reason for a truck cap.) {{< cite doc="appendix-l" label="Verify Fact" >}}
{{< /fact-compare >}}
{{< /accordion >}}
...
A 24/7 industrial building would sit **54 feet** from homes to the north and **150 feet** from homes to the east, with no noise mitigation and no cap on trucks. {{< cite doc="opposition-site-plan" label="Verify Fact" >}}
{{< /fact-compare >}}
{{< /accordion >}}
...
3. **Public comment** — **you speak** (usually 3–5 minutes per person)
